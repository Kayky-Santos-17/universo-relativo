    ...
    return (
      <div className="login-screen">
        ...
        <div className="login-success">
          ...
          <h2 className="login-success-title">Bem-vindo ao universo</h2>
          <p className="login-success-sub">Preparando sua jornada...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="login-screen">
      ...
      <div className="login-layout">
        ...
        <div className="login-box glass-panel">
          ...
          <button className="btn-google w-100" type="button" onClick={handleGoogle} disabled={loading}>
