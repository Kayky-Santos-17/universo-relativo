...
function HeroAstronaut() {
  return (
    <div className="hero-astronaut" aria-hidden="true">
      <svg className="hero-astronaut-svg" viewBox="24 2 166 254" xmlns="http://www.w3.org/2000/svg">
        <defs>
          ...
          <radialGradient id="astroPlanet" cx="30%" cy="30%" r="75%">
        ...
        <line x1="84" y1="176" x2="78" y2="236" stroke="url(#astroSuit)" strokeWidth="24" strokeLinecap="round" />
        <line x1="116" y1="176" x2="122" y2="236" stroke="url(#astroSuit)" strokeWidth="24" strokeLinecap="round" />
        <ellipse cx="78" cy="240" rx="18" ry="11" fill="#5b21b6" />
        <ellipse cx="122" cy="240" rx="18" ry="11" fill="#5b21b6" />

        <rect x="62" y="96" width="76" height="90" rx="30" fill="url(#astroSuit)" />
        ...
        <line x1="66" y1="110" x2="44" y2="168" stroke="url(#astroSuit)" strokeWidth="22" strokeLinecap="round" />
        <circle cx="44" cy="168" r="13" fill="#e9edf3" />

        <line x1="134" y1="108" x2="170" y2="58" stroke="url(#astroSuit)" strokeWidth="22" strokeLinecap="round" />
        <circle cx="170" cy="58" r="13" fill="#e9edf3" />

        <rect x="76" y="90" width="48" height="16" rx="8" fill="#e2e8f0" />

        <circle cx="100" cy="54" r="46" fill="url(#astroSuit)" stroke="#c7cdd6" strokeWidth="4" />
        <circle cx="100" cy="54" r="34" fill="url(#astroVisor)" />

        <circle cx="88" cy="46" r="8" fill="url(#astroPlanet)" />
        ...
        <g fill="#e9d5ff">
          ...
          <circle cx="178" cy="190" r="2.5" />
          <circle cx="32" cy="210" r="2" />
          <path d="M176 30 l2.5 6 6 2.5 -6 2.5 -2.5 6 -2.5 -6 -6 -2.5 6 -2.5z" />
        </g>
      </svg>
    </div>
  );
...
export default memo(HeroAstronaut);
