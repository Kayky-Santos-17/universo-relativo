...
const SOCIAL_LINKS = {
  Instagram: "https://instagram.com/universorelativofisica",
  YouTube: "https://youtube.com/@universorelativofisica",
  TikTok: "https://tiktok.com/@universorelativofisica"
};
    ...
    <footer className="landing-footer">
      <div className="landing-footer-inner">
        <div className="landing-footer-brand">
          <strong className="landing-footer-logo">Universo Relativo</strong>
          <p className="landing-footer-desc">Transformando o aprendizado de física.</p>
        </div>
        ...
        <div className="landing-footer-socials">
          {SOCIALS.map((s) => (
            <a key={s.label} href={SOCIAL_LINKS[s.label]} target="_blank" rel="noopener noreferrer" className="landing-footer-social-icon" aria-label={s.label} title={s.label}>
